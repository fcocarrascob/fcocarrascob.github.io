...
con $\phi = 0.90$ para secciones controladas por tracción ($\varepsilon_t \geq \varepsilon_{ty} + 0.003$, que para Grado 420 da el familiar $0.005$).
...
\left(0.17 + \dfrac{0.33}{\beta}\right)\lambda_s\,\lambda\sqrt{f'_c} \\[4pt]
\left(0.17 + \dfrac{0.083\,\alpha_s d}{b_o}\right)\lambda_s\,\lambda\sqrt{f'_c}
\end{cases}
$$
</Equation>
