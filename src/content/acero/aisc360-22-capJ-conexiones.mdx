...
|----------|:--------:|:--------------------------------:|:--------------------------------:|
| A307 | 310 MPa | 190 MPa | 190 MPa |
| Grupo A (A325) | 620 MPa | 370 MPa | 470 MPa |
| Grupo B (A490) | 780 MPa | 470 MPa | 580 MPa |
| Partes roscadas | $0.75 F_u$ | $0.450 F_u$ | $0.563 F_u$ |

Son los valores de la **columna métrica** de la Tabla J3.2, no la conversión exacta de las ksi
—54 ksi son 372 MPa y la tabla tabula 370—: en un cálculo en unidades métricas se usa la columna
métrica, y es la convención de todos los ejemplos de este sitio.
