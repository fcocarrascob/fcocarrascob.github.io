...
Aunque el perno resista, la **plancha** puede ceder donde el perno apoya. El estado límite
combina dos mecanismos en una sola fórmula: **aplastamiento** (el agujero se ovala, tope
...
agujero o el borde del material), $d$ el diámetro del perno y $t$ el espesor. El primer
término gobierna cuando el perno está cerca del borde (poco $l_c$ → desgarre); el tope
$2.4\,dtF_u$ gobierna cuando hay espacio de sobra (aplastamiento puro). Si la deformación
**no** es consideración de diseño, los coeficientes suben a $1.5$ y $3.0$ (Ec. J3-6b).
...
| Apoyo en la plancha | $1.2 l_c t F_u \leq 2.4 d t F_u$ (Ec. J3-6a) | frágil — aplastam./desgarre |
